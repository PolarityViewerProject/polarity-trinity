    ...
    try:
        ...
        with Janitor(LOGF) as janitor:
            ...
            for candidate in glob.glob(os.path.join(mntdir, "*.app")):
                ...
                fail("Could not find Polarity viewer in " + dmgfile)
            ...
            # the app bundle on our .dmg installer (e.g. "Polarity Beta
            ...
            # Life.app" into "/Applications/Polarity Beta Neato.app". This
